...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun WhereToSearchOverlay(
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "Service area: San Jose, Dinagat Islands only",
                    fontSize = 12.sp,
            ...
            // Expanded content when user types
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Spacer(modifier = Modifier.width(8.dp))
                Text(
                    text = "Going to: ${booking.destination.address}",
                    fontSize = 14.sp,
                    color = Color.Black
                )
            }
...
@Composable
private fun TripHistoryItem(trip: Booking) {
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = formatter.format(kotlin.math.floor(trip.fareEstimate.totalEstimate)),
                    fontSize = 16.sp,
                    fontWeight = FontWeight.Bold
                )
            }
...
@Composable
private fun LandmarkBookingDialog(
    landmark: Point,
    landmarkAddress: String,
    currentLocation: Point?,
    onBookRide: (Point, String) -> Unit,
    onDismiss: () -> Unit
) {
    AlertDialog(
        ...
        text = {
            Column(
                ...
                Text(
                    text = "Book a ride to this location?",
                    fontSize = 16.sp
                )
                ...
                // Coordinates display
                Text(
                    text = "Lat: ${String.format("%.6f", landmark.latitude())}, Lng: ${String.format("%.6f", landmark.longitude())}",
                    fontSize = 12.sp,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
        ...
        confirmButton = {
            Button(
                onClick = { onBookRide(landmark, landmarkAddress) },
                colors = ButtonDefaults.buttonColors(
                    containerColor = IslamovePrimary
                )
            ) {
