...
fun PassengerHomeScreen(
    ...
    LaunchedEffect(uiState.successMessage) {
        uiState.successMessage?.let {
            // Success message will auto-clear after 3 seconds (handled in ViewModel)
        }
    }
        ...
        uiState.successMessage?.let { message ->
            Card(
                ...
                colors = CardDefaults.cardColors(
                    containerColor = Color(0xFF4CAF50).copy(alpha = 0.1f) // Light green background
                )
            ) {
                Row(
                    modifier = Modifier
                                ...
                                .addOnSuccessListener {
                                    ...
                                    user.verifyBeforeUpdateEmail(editingEmail)
                                        ...
                                        .addOnFailureListener { e ->
                                            ...
                                            isUpdating = false
                                            android.util.Log.e("ProfileUpdate", "Email verification failed", e)
                                        }
                                }
                                .addOnFailureListener { e ->
                                    updateMessage = when {
